...
{	
	// Information to properly display
	// of one tile in the game.
	private Board board;
	private Location pieceSelected;
	private AI.Move potentialMove;
	private BufferedImage image;

	// Images that display tiles
	// and pieces.
	...
	@Override
	/**
	 * Repaints the component after you select
	 * a tile.
	 */
	...
	public void mouseClicked(MouseEvent e) 
	{
		...
		if (pieceSelected == null)
		{
			...
			// Get the pieces of whose turn it is
			...
			// Get the piece in the curent location.
			int currPiece;
		...
		// Otherwise move the piece to loc
		else
		{
	...
	/**
	 * @return Returns a random image icon
	 */
	...
	/**
	 * @return Returns the image icon of player
	 */
