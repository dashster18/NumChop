...
{
	// Constants needed for different things
	...
	// This is a really nice green color we found 
	public static final Color GREEN = new Color(0x00CD00); 
	public static final Color RED = Color.RED;
	
	// Constants to determine whose turn it is
	...
	// Internal 2D array for the game state
	// along with which peices have been visited
	...
	// Where each player's piece is located
	...
	// We store the history of multiple moves
	// and can display all the moves if we
	// need to.
	...
	/** 
	 * Copy constructor that transfers the 
	 * state from Board b to this Board
	 */
	...
	public boolean getAI(int player) {
		if (player == PLAYER_1) {
			return isPlayer1AI;
		}
		else if (player == PLAYER_2) {
