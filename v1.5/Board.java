...
public class Board extends Observable
{
	...
	public void move (Location from, Location to, int pieceNum)
	{
		if (turn == PLAYER_1)
		{
	...
	public boolean checkValidMove (Location from, Location to)
	{
		...
		int colT = to.getCol();
			...
			//If move is father than one square or
	...
	//Un moves a given move. Only used by the AI.
	public void unMove (Location to, Location from, boolean con, int pieceNum)
	{
		turn = 1 - turn;
