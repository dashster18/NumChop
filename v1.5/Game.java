...
public class Game implements Observer
{
	...
	public void update(Observable o, Object arg) 
	{
		...
		if (b.getLastMove().equals(Board.NO_MOVES_MADE_YET)) {
			lastMoveLabel.setForeground(Color.BLACK);
		}
		else {
			lastMoveLabel.setForeground(board.getPlayerColor(1 - board.getTurn()));
		}
		lastMoveLabel.setText(b.getLastMove());
		...
		if ((ai1 != null && board.getTurn() == Board.PLAYER_2) || b.endOfGame())
		{
			ai1.ready.release();
		}

		if ((ai0 != null && board.getTurn() == Board.PLAYER_1) || b.endOfGame())
		{
			ai0.ready.release();
		}
